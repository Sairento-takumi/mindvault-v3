...
**363 passed + 13 subtests** (회귀 0, v3.2.2 기준 카운트). functional 전부 OK, v3.0.x 의 e2e perf 회귀 (avg 452ms > 150ms) 는 NEXT-27/28 fix 로 해소 (현재 p50=40ms). 네트워크/Gemma 불필요 (mocked).
